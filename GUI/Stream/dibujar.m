...
if cuf > 1
    ...
    m = uimenu(c,'Label','Eliminar Flujo','Callback',@Eliminar_modulof);
    m.UserData=cIdx;
    setappdata(p1,'TagIdentifier',[TagIdentifier 2])
    setappdata(plot_h,'TagIdentifier',[TagIdentifier 2])
    setappdata(p2,'TagIdentifier',[TagIdentifier 2])
    setappdata(l1,'TagIdentifier',[TagIdentifier 2])
    setappdata(l2,'TagIdentifier',[TagIdentifier 2])
    setappdata(c,'TagIdentifier',[TagIdentifier 2])
    
    plot_h.UIContextMenu.Children(1).UserData=cIdx;
