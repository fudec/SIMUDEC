...
if  isempty(Info(x).Container)
    ...
    return
        ...
        D_sim=Info(x).Container.D_sim;
        D_ori=Info(x).Container.D_ori;
        
        L_sim=Info(x).Container.L_sim;
        L_ori=Info(x).Container.L_ori;
        
        CS_sim=Info(x).Container.CS_sim;
        CS_ori=Info(x).Container.CS_ori;
        
        FL_sim=Info(x).Container.FL_sim;
        FL_ori=Info(x).Container.FL_ori;
        
        WI_sim=Info(x).Container.WI_sim;
        WI_ori=Info(x).Container.WI_ori;
        
        Kn1=Info(x).Container.Kn1;
        Kn1v=Info(x).Container.Kn1v;
        
        Kn2=Info(x).Container.Kn2;
        Kn2v=Info(x).Container.Kn2v;
        
        Kn3=Info(x).Container.Kn3;
        Kn3v=Info(x).Container.Kn3v;
        
        Kn4=Info(x).Container.Kn4;
        Kn4v=Info(x).Container.Kn4v;
        
        Db_sim=Info(x).Container.Db_sim;
        Db_ori=Info(x).Container.Db_ori;
        
        Breakage_factor=Info(x).Container.Breakage_factor;
...
editbox_D_sim=uicontrol(scale_bgD,'style','edit','string',D_sim);
editbox_D_sim.Position = [Px Diametroy 30 15];

editbox_D_ori=uicontrol(scale_bgI,'style','edit','string',D_ori);
...
editbox_Largo_sim=uicontrol(scale_bgD,'style','edit','string',L_sim);
editbox_Largo_sim.Position = [Px Largoy 30 15];

editbox_Largo_ori=uicontrol(scale_bgI,'style','edit','string',L_ori);
...
CSy=70;
CSxT=4;
editbox_CS_sim=uicontrol(scale_bgD,'style','edit','string',CS_sim);
editbox_CS_sim.Position = [Px CSy 30 15];

editbox_CS_ori=uicontrol(scale_bgI,'style','edit','string',CS_ori);
...
editbox_FL_sim=uicontrol(scale_bgD,'style','edit','string',FL_sim);
editbox_FL_sim.Position = [Px FLy 30 15];

editbox_FL_ori=uicontrol(scale_bgI,'style','edit','string',FL_ori);
...
WIy=40;
WIxT=1;
editbox_WI_sim=uicontrol(scale_bgD,'style','edit','string',WI_sim);
editbox_WI_sim.Position = [Px WIy 30 15];

editbox_WI_ori=uicontrol(scale_bgI,'style','edit','string',WI_ori);
...
Kn1_edit=uicontrol(si_bg,'style','edit','string',Kn1);
...
Kn1_editD=uicontrol(si_bg,'style','edit','string',Kn1v);
...
Kn2_edit=uicontrol(si_bg,'style','edit','string',Kn2);
...
Kn2_editD=uicontrol(si_bg,'style','edit','string',Kn2v);
...
Kn3_edit=uicontrol(si_bg,'style','edit','string',Kn3);
...
Kn3_editD=uicontrol(si_bg,'style','edit','string',Kn3v);
...
Kn4_edit=uicontrol(si_bg,'style','edit','string',Kn4);
...
Kn4_editD=uicontrol(si_bg,'style','edit','string',Kn4v);
Kn4_editD.Position = [Px+PxKn2 Kn4y 30 15];
%%%%%%%%%% EScalamiento bolas %%%%%%%%%5

si_bg= uibuttongroup(figure_modelo_c,...
                  'Title','Grinding Balls',...
...
Balltop_edit_ori=uicontrol(si_bg,'style','edit','string',Db_ori);
...
Balltop_edit_sim=uicontrol(si_bg,'style','edit','string',Db_sim);
...
Breakage_factor_edit=uicontrol(si_bg,'style','edit','string',Breakage_factor);
